...
using _053502_Yurev_Lab6.Interfaces;

namespace _053502_Yurev_Lab6.Collections
{
    class Node<T>
    {
        public T _Data;
        ...
        public void Remove(T item)
        {
            try
            {
                ...
                while (!(temp._Data.Equals(item)) && temp._Next != null)
                {
                    ...
                    if (temp._Next == null && !temp._Data.Equals(item))
                    {
                        throw new MyException("No such element exists.");
                    }
                }
